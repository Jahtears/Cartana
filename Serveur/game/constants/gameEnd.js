...
function normalizeGameEndReason(reason, fallback = GAME_END_REASONS.ABANDON) {
  ...
  if (raw === GAME_END_REASONS.PILE_EMPTY) {
    return GAME_END_REASONS.PILE_EMPTY;
  }
  if (GAME_END_REASON_SET.has(raw)) {
    return raw;
  }
...
export { GAME_END_REASONS, GAME_END_REASON_SET, normalizeGameEndReason };
