import { buildSlotStatePayload, buildStateSnapshotPayload, publicGameEndResult } from "../../game/payload/snapshotPayload.js";
...
function isRematchAllowedForPlayer(game, gameId, meta, wsByUser, userToGame, userToEndGame, username) {
...
export function emitFullState(
  ...
  let result = null;
  const forceDisableDrag = !!game?.turn?.paused;
  if (gameMeta && game_id) {
